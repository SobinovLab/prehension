...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Do not save the figures (saving is on by default, into "
             "<processed_server>/pooled_figures/figure_spaces_dpca_pooled, named after "
             "the --sessions string with a per-figure suffix).")
    ...
    figure_spaces_dpca_pooled(
        ...
        min_rate=args.min_rate, n_components=args.n_components, name=name, save=args.save)
