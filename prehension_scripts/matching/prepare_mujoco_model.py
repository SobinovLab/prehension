...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Generates a mask of pressure sensors matrix that highlights activated "
    ...
    tools.add_default_arguments(parser, ("sessions", "trials", "temp", "overwrite"))

    parser.add_argument(
        "--dont_make_mask", action="store_false", dest="make_mask", help="Converts."
    )
    parser.add_argument(
        "--dont_tessellate",
        action="store_false",
