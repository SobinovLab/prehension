...
def predict_points_jarvis(
    ...
    Arguments:
        ...
        predict {bool} --- Do not run JARVIS on the videos.
        transform {bool} --- Do not transform JARVIS files into our format and create IK files.
    ...
    for session in tqdm.tqdm(sessions, ncols=100, desc="Sessions"):
        ...
        for trial in tqdm.tqdm(msession, ncols=100, desc="Finding trials"):
            ...
            # Skip condition 1
            if (
                os.path.isfile(trial.markers_3D_filename_jarvis_csv)
                and os.path.isfile(trial.markers_3D_filename_csv)
                and not overwrite
            ):
                continue
