...
PRESETS = {
    ...
    'example_preset_1': {
        ...
        'default_server': os.path.join('C:\\', 'Data', 'M1LeftHemisphere', 'sessions'),
        # The server to write the data to
        'processed_server': os.path.join('C:\\', 'Data', 'M1LeftHemisphere', 'sessions'),
        ...
        'scaling': {'session': '2021_04_29', 'trial': 63},
