...
from prehension.materialsio_colors import materialsio_colors_rgb as micolors
...
class ForceLabellingInterface:
    ...
    def export_matched_data(self):
        ...
        ncams.io_utils.export_csv(self.trial.manually_labelled_filename, column_names, values)
...
def main(server, session, trial_number, temp,
...
if __name__ == '__main__':
    ...
    main(args.server, args.session, args.trial, args.temp,
