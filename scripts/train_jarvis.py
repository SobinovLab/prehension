...
from jarvis.ui.interactive_cli.predict_cli import get_trt_mode, get_frame_start_number
...
def main(combos, epochs, verbose):
    n_proc = len(combos)
...
if __name__ == "__main__":
    ...
    main(args.combos, args.epochs, args.verbose)
