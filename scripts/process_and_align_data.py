...
def transform_trial(trial, mdof, ja_filter, object_def, make_plots=False):
    # load joint angles
    f_dof_names, ja_times, dofs = ncams.io_utils.import_mot(trial.pre_kinematic_filename)
    ...
    ncams.io_utils.export_mot(trial.post_kinematic_filename_mot,
    ...
    ncams.io_utils.export_csv(trial.post_kinematic_filename_csv,
...
def main(server, sessions, trials_sel, temp, processes, overwrite, make_plots):
